...
formValidators[profileForm.getAttribute('name', 'link')].resetValidation();
...
function handlePreviewImage(imageData) {
    ...
    previewImage.src = imageData._link;
    previewImage.alt = imageData._name;
    previewImageTitle.textContent = imageData._name;
}
